  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', backgroundColor: 'var(--bg)' }}>
      <div style={{ width: '400px', backgroundColor: 'var(--white)', padding: '40px', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
        ...
        <Link to="/" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', color: 'var(--text-mid)', textDecoration: 'none', fontSize: '13px', fontWeight: '600', marginBottom: '24px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          ...
          <p style={{ color: 'var(--text-mid)', marginTop: '5px' }}>Nexmsg Account Recovery</p>
        </div>
